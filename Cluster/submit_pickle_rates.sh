#!/bin/bash
#SBATCH --job-name=pickle_rates 				# job name
#SBATCH --nodes=1 					# Number of nodes
#SBATCH --ntasks=10 				# Number of cores
#SBATCH --output=/n/holystore01/LABS/berger_lab/Users/aboesky/two_parameters/pickle_rates.out 				# output storage file
#SBATCH --error=/n/holystore01/LABS/berger_lab/Users/aboesky/two_parameters/pickle_rates.err 					# error storage file
#SBATCH --time=50:00:00 					# Runtime (hr:min:second)
#SBATCH --mem=184GB 					# Memory per cpu in MB (see also --mem-per-cpu)
#SBATCH -p shared
...
#
# Run your job
python /n/home04/aboesky/berger/Exploring_Parameter_Space/Cluster/pickle_rates_run.py 
