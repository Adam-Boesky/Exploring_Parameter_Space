...
from pickle_writers import pickle_rates_and_boostraps, pickle_rates_and_boostraps_by_metallicity, pickle_rates_and_boostraps_for_desired_redshfits, pickle_weights_for_all_redshfits, pickle_rates_and_boostraps_by_formation_channel, pickle_rates_and_boostraps_by_delay_time

def pickle_results(compas_results_path, pickled_results_dir, alpha_val, beta_val, dco_type, weight_column=None,
    ...
    # pickle_rates_and_boostraps(compas_results_path, pickled_results_dir, 
    ...
    # # Breaking up rates by metallicity bins
    # pickle_rates_and_boostraps_by_metallicity(compas_results_path, pickled_results_dir, 
    # dco_type=dco_type, merger_output_filename=None, weight_column=weight_column,
    # merges_hubble_time=merges_hubble_time, pessimistic_CEE=pessimistic_CEE,
    # no_RLOF_after_CEE=no_RLOF_after_CEE, max_redshift=max_redshift,
    # max_redshift_detection=max_redshift_detection,
    ...
    # # Breaking up rates by metallicity bins
    # pickle_rates_and_boostraps_for_desired_redshfits(compas_results_path, pickled_results_dir, 
    # dco_type=dco_type, merger_output_filename=None, weight_column=weight_column,
    # merges_hubble_time=merges_hubble_time, pessimistic_CEE=pessimistic_CEE,
    # no_RLOF_after_CEE=no_RLOF_after_CEE, max_redshift=max_redshift,
    # max_redshift_detection=max_redshift_detection,
    ...
    # # Save ALL rate weights
    # pickle_weights_for_all_redshfits(compas_results_path, pickled_results_dir, 
    # dco_type=dco_type, merger_output_filename=None, weight_column=weight_column,
    # merges_hubble_time=merges_hubble_time, pessimistic_CEE=pessimistic_CEE,
    # no_RLOF_after_CEE=no_RLOF_after_CEE, max_redshift=max_redshift,
    # max_redshift_detection=max_redshift_detection,
    ...
    # # Pickle rates by formation channel
    # pickle_rates_and_boostraps_by_formation_channel(compas_results_path, pickled_results_dir, 
    # dco_type=dco_type, merger_output_filename=None, weight_column=weight_column,
    # merges_hubble_time=merges_hubble_time, pessimistic_CEE=pessimistic_CEE,
    # no_RLOF_after_CEE=no_RLOF_after_CEE, max_redshift=max_redshift,
    # max_redshift_detection=max_redshift_detection,
    ...
    # Pickle rates by delay time
    pickle_rates_and_boostraps_by_delay_time(compas_results_path, pickled_results_dir, 
    dco_type=dco_type, merger_output_filename=None, weight_column=weight_column,
    merges_hubble_time=merges_hubble_time, pessimistic_CEE=pessimistic_CEE,
    no_RLOF_after_CEE=no_RLOF_after_CEE, max_redshift=max_redshift,
    max_redshift_detection=max_redshift_detection,
...
def calcuate_rates_and_pickle(alpha_val, beta_val, dco_type, mssfr_prescription, output_files_path, compas_results_path):    

    # DEFINE PARAMETERS
    # THESE ARE THE FIDUCIAL PARAMETERS USED IN BOESKY+2022
    ...
    redshift_step          = 0.1   # 0.1 TESTING A LOWER STEP SIZE FOR FLOOR.            Other is 0.001 
    z_first_SF             = 10
    ...
    # Make a folder to put the data into (we make sure that there isn't already an existing folder first)
    mssfr_dir = output_files_path + 'Pickled_Rates/' + mssfr_prescription
    if not os.path.exists(mssfr_dir):
        os.mkdir(mssfr_dir)
    pickled_results_dir = output_files_path + 'Pickled_Rates/' + mssfr_prescription + '/' + dco_type
    # if os.path.exists(pickled_results_dir): # We ALWAYS overwrite the existing directory if it exist
    #     shutil.rmtree(pickled_results_dir)
    # os.mkdir(pickled_results_dir)
    # pickled_results_file = output_files_path + 'Pickled_Rates/' + mssfr_prescription + '/' + dco_type + '/' + 'rates_and_bootstraps_by_Z.h5'
    # if os.path.isfile(pickled_results_file):
    #     os.remove(pickled_results_file)
    pickled_results_file = output_files_path + 'Pickled_Rates/' + mssfr_prescription + '/' + dco_type + '/' + 'rates_and_bootstraps_by_delay_time.h5'
    if os.path.isfile(pickled_results_file):
        os.remove(pickled_results_file)

    # Write to Pickle!!!!
    pickle_results(compas_results_path, pickled_results_dir, alpha_val, beta_val, dco_type=dco_type, weight_column=weight_column,
                merges_hubble_time=merges_hubble_time, pessimistic_CEE=pessimistic_CEE,
                no_RLOF_after_CEE=no_RLOF_after_CEE, max_redshift=max_redshift,
                max_redshift_detection=max_redshift_detection,
                redshift_step=redshift_step, z_first_SF=z_first_SF,
